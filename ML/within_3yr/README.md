...
2. `02_sfs.py`
   - 5-fold LightGBM sequential forward selection
3. `03_plot.py`
   - SFS figure using the selected panel as the default display
4. `04_roc.py`
   - 5-fold out-of-fold ROC evaluation
5. `05_shap.py`
...
- final ROC and SHAP outputs are based on 5-fold out-of-fold evaluation rather than a separate holdout split
